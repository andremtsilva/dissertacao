...
def main(stop_time, it):
    ...
    #size = 20
    size = 5
    #t.G = nx.complete_graph(size) # In NX-lib there are a lot of Graphs generators
    t.G = nx.binomial_tree(size)
    ...
    # Weight test for acopy
    attWeight = {x: random.randint(1,4) for x in t.G.edges()}
    nx.set_edge_attributes(t.G, name="weight", values=attWeight)
    ...
    """
    # Power
    attPow = {x: random.randint(100, 900) for x in t.G.nodes()}
    nx.set_node_attributes(t.G, name="Pow", values=attPow)
    """
    ...
    nx.write_graphml(t.G,folder_results+"graph_complete_%i.graphml"%size)
...
#    print()
#    print(nx.get_node_attributes(t.G, "Pow"))
#    print()
#    print(nx.get_edge_attributes(t.G, "BW"))
#    print()
#    print(nx.get_edge_attributes(t.G, "PR"))
#    print()
